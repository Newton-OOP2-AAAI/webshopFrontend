...
class Home extends React.Component{
  ...
  {/* Start Banner Hero */}
  <div id="template-mo-AAAI-hero-carousel" className="carousel slide" data-bs-ride="carousel">
    <ol className="carousel-indicators">
      <li data-bs-target="#template-mo-AAAI-hero-carousel" data-bs-slide-to={0} className="active" />
      <li data-bs-target="#template-mo-AAAI-hero-carousel" data-bs-slide-to={1} />
      <li data-bs-target="#template-mo-AAAI-hero-carousel" data-bs-slide-to={2} />
    </ol>
        ...
        <div className="container">
          <div className="row p-5">
            <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
              <img className="img-fluid" src="./assets/img/thorpopbanner2.jpg" alt />
            </div>
            <div className="col-lg-6 mb-0 d-flex align-items-center">
              <div className="text-align-left align-self-center">
                <h1 className="h1 text-success"><b>AAAI</b> eCommerce</h1>
                <h3 className="h2">You want it, we got it!</h3>
                <p>
                  AAAI Shop is a global leader in providing products related to video games, anime, super heroes, board games and more. Our goal is to provide quick and easy access to the products that we and our customers are passionate about. 
                  Shipping will cost tree fiddy and orders will be delivered by the goddamn Loch Ness Monster.
          ...
          <div className="row p-5">
            ...
            <div className="col-lg-6 mb-0 d-flex align-items-center">
              <div className="text-align-left">
                ...
                <p>
                  You are permitted to use this AAAI CSS template for your commercial websites. 
    ...
    <a className="carousel-control-prev text-decoration-none w-auto ps-3" href="#template-mo-AAAI-hero-carousel" role="button" data-bs-slide="prev">
      <i className="fas fa-chevron-left" />
    </a>
    <a className="carousel-control-next text-decoration-none w-auto pe-3" href="#template-mo-AAAI-hero-carousel" role="button" data-bs-slide="next">
    ...
    <div className="row text-center pt-3">
      <div className="col-lg-6 m-auto">
        ...
        <p>
          ...
          Look at this month's popular products for some inspiration!
        </p>
      </div>
    </div>
    <div className="row">
      ...
      <div className="col-12 col-md-4 p-5 mt-3">
        ...
        <h2 className="h5 text-center mt-3 mb-3">Video Games</h2>
        <p className="text-center"><a className="btn btn-success">Go Shop</a></p>
      </div>
    </div>
  </section>
