  ...
  render() {
    return (
      <div>
        ...
        {/* Start Banner Hero */}
        <div
          id="template-mo-AAAI-hero-carousel"
          className="carousel slide"
          data-bs-ride="carousel"
        >
          <ol className="carousel-indicators">
            <li
              data-bs-target="#template-mo-AAAI-hero-carousel"
              data-bs-slide-to={0}
              className="active"
            />
            <li
              ...
              <div className="container">
                <div className="row p-5">
                  <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                    <img
                      className="img-fluid"
                      src="./assets/img/thorpopbanner2.jpg"
                    />
                  </div>
                  <div className="col-lg-6 mb-0 d-flex align-items-center">
                    <div className="text-align-left align-self-center">
                      ...
                      <p>
                        AAAI Shop is a global leader in providing products
                        related to video games, anime, super heroes, board games
                        and more. Our goal is to provide quick and easy access
                        to the products that we and our customers are passionate
                        about. Shipping will cost tree fiddy and orders will be
                        delivered by the goddamn Loch Ness Monster.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="row p-5">
                  ...
                  <div className="col-lg-6 mb-0 d-flex align-items-center">
                    <div className="text-align-left">
                      ...
                      <p>
                        You are permitted to use this AAAI CSS template for your
          ...
          <a
            ...
            href="#template-mo-AAAI-hero-carousel"
            role="button"
            data-bs-slide="prev"
          >
        ...
        <section className="container py-5">
          <div className="row text-center pt-3">
            <div className="col-lg-6 m-auto">
              ...
              <p>
                Can't decide what to get? Look at this month's popular products
                ...
                (<div className="col-12 col-md-4 mb-4" key={product.id}>
                  <div className="card h-100">
                    <Link to={'/product/' + product.id}>
                      <img
                        src={'/assets/img/' + product.id + '_0.jpg'}
                    ...
                    <div className="card-body">
                      <ul className="list-unstyled d-flex justify-content-between">
                        ...
                        <li className="text-muted text-right">${product.price}.00</li>
                      </ul>
                      <Link
